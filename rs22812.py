...
class RS22812(object):
    ...
    def __init__(self, com_port="COM11"):
        ...
        baudrate = 4800
        self.sp = serial.Serial(com_port, baudrate, timeout=0)
    ...
    def InterpretReading(self, string):
        ...
        # Get sign
        sign = ""
        if v_bytes[7] & (1 << 3):  sign = "-"
        # Get units
        units = self.GetUnits(v_bytes)
        # Construct number
        ...
        return reading, mode, self.GetModifiers(v_bytes)
